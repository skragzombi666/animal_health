...
from .v0920_features import (
    async_initialize_v0920_features,
    async_refresh_v0920_catalog,
    async_setup_v0920_features,
)
...
from .v0936_features import apply_v0936_patches
from .v0941_features import apply_v0941_patches
...
async def async_setup(hass: HomeAssistant, config: dict[str, Any]) -> bool:
    ...
    await async_setup_v0927_features(hass)
    await async_setup_v0928_features(hass)
