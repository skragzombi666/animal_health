...
AH016.decorateCaptureButton016=function(button){
 ...
 button.innerHTML=`<span class="captureIcon016"><ha-icon icon="${definition.icon}"></ha-icon></span><span class="captureLabel016">${esc(this.t(definition.label))}</span>`
};
...
.quickCaptureCompact091,.quickCaptureGrid{display:grid!important;grid-template-columns:repeat(6,minmax(0,1fr))!important;gap:6px!important}.animalCaptureIcons090A7{display:grid!important;grid-template-columns:repeat(7,minmax(0,1fr))!important;gap:6px!important;align-items:stretch!important}.captureTile016{position:relative!important;overflow:visible!important;min-width:0!important;width:100%!important;height:auto!important;min-height:68px!important;padding:7px 3px 5px!important;display:grid!important;grid-template-rows:34px minmax(14px,auto)!important;place-items:center!important;align-content:center!important;gap:4px!important;border-radius:12px!important}.captureIcon016{position:relative;display:grid;place-items:center;width:32px;height:32px}.captureIcon016>ha-icon{width:26px!important;height:26px!important}.captureLabel016{display:block;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:.68rem;line-height:1.05;color:var(--secondary-text-color);text-align:center}.captureTile016.primary .captureLabel016{color:var(--text-primary-color,#fff)}@media(max-width:520px){.quickCaptureCompact091,.quickCaptureGrid{gap:4px!important}.animalCaptureIcons090A7{gap:4px!important}.captureTile016{min-height:64px!important;padding:6px 2px 4px!important;border-radius:10px!important}.captureIcon016{width:30px;height:30px}.captureIcon016>ha-icon{width:24px!important;height:24px!important}.captureLabel016{font-size:.61rem}.animalCaptureIcons090A7 .captureLabel016{font-size:.57rem}}
</style>`
};
