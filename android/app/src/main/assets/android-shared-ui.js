(()=>{
const iconMap={"mdi:paw":"●","mdi:menu":"☰","mdi:refresh":"↻","mdi:view-dashboard":"⌂","mdi:clipboard-check":"✓","mdi:calendar":"▦","mdi:timeline-clock":"◷","mdi:account-group-outline":"👥","mdi:cog-outline":"⚙","mdi:plus-circle-outline":"＋","mdi:clipboard-plus":"＋","mdi:scale":"⚖","mdi:alert-circle-outline":"!","mdi:pill":"◆","mdi:note-plus-outline":"＋","mdi:creation-outline":"✦","mdi:magnify":"⌕","mdi:close":"×","mdi:pencil-outline":"✎","mdi:delete-outline":"×","mdi:file-pdf-box":"PDF","mdi:archive-outline":"□","mdi:download-outline":"↓","mdi:image-plus-outline":"▣","mdi:image-remove-outline":"×","mdi:chevron-right":"›","mdi:arrow-left":"←","mdi:check-circle-outline":"✓","mdi:medical-bag":"✚","mdi:stethoscope":"♡","mdi:needle":"†","mdi:bell-outline":"•","mdi:scale-bathroom":"⚖"};
...
async function install(){
 ...
 const hass={language:"de-CH",user:{is_admin:true,name:"Android"},callWS:request=>nativeCall(request),callService:(domain,service,serviceData)=>nativeCall({type:"call_service",domain,service,service_data:serviceData||{}})};
