...
console.log("Animal Health 0.9.0-alpha.5 dashboard runtime validation passed");
'''
...
def main() -> None:
    ...
    assert manifest["version"] == "0.9.0-alpha.5"
    assert 'const V="0.9.0-alpha.5",D="animal_health"' in source
    ...
    print("Animal Health 0.9.0-alpha.5 dashboard frontend validation passed")
