...
console.log("Animal Health 0.8.12 dashboard runtime validation passed");
'''
...
def main() -> None:
    ...
    assert 'const V="0.8.12",D="animal_health"' in source
    ...
    print("Animal Health 0.8.12 dashboard frontend validation passed")
