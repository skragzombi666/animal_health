...
console.log("Animal Health 0.9.0-alpha.2 dashboard runtime validation passed");
'''
...
def main() -> None:
    ...
    assert 'const V="0.9.0-alpha.2",D="animal_health"' in source
    ...
    print("Animal Health 0.9.0-alpha.2 dashboard frontend validation passed")
