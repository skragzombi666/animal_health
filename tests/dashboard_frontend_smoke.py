...
console.log("Animal Health 0.8.11 dashboard runtime validation passed");
'''
...
def main() -> None:
    ...
    assert 'const V="0.8.11",D="animal_health"' in source
    ...
    print("Animal Health 0.8.11 dashboard frontend validation passed")
