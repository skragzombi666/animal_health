...
console.log("Animal Health 0.9.0-alpha.3 dashboard runtime validation passed");
'''
...
def main() -> None:
    ...
    assert manifest["version"] == "0.9.0-alpha.3"
    assert 'const V="0.9.0-alpha.3",D="animal_health"' in source
    ...
    print("Animal Health 0.9.0-alpha.3 dashboard frontend validation passed")
