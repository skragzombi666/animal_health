...
panel.h={language:"de"};
panel.d={version:"0.7.4",today:"2026-08-08",summary:{active_animals:1,overdue_tasks:0,today_tasks:0,upcoming_tasks:1,pending_tasks:1},animals:[{id:"AH-1",device_id:"device-1",name:"Curry",species:"Huhn",status:"active",is_archived:false}],tasks:[{id:"TK-OFF",title:"Wägen",task_kind:"weight",recurrence_type:"weekly",is_active:false,animal_name:"Curry"}],occurrences:[{id:"OC-1",task_id:"TK-OFF",task_title:"Wägen",task_kind:"weight",animal_id:"AH-1",animal_name:"Curry",status:"pending",scheduled_local:"2026-08-09T14:00:00+02:00",scheduled_date:"2026-08-09",is_overdue:false,is_today:false,is_upcoming:true}],events:[{id:"EV-1",animal_id:"AH-1",animal_name:"Curry",event_type:"symptom",title:"diarrhea",occurred_at:"2026-08-08T13:21:00+02:00",notes:"Test"},{id:"EV-2",animal_id:"AH-1",animal_name:"Curry",event_type:"status_change",title:"status_change",occurred_at:"2026-08-08T15:29:00+02:00"}]};
...
def main() -> None:
    ...
    assert 'const V="0.7.4",D="animal_health"' in source
    for path in (
    ...
    for marker in ("animal-health-brand.svg","navigator.mediaDevices.getUserMedia","attachmentPreview","groups/archive","groups/restore","preparingDownload","applyTaskVisibility","eventDetails"):
